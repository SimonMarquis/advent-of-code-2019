import Day09.IntcodeComputer.Mode.*
...
class Day09(input: String) {
    ...
    fun part1(input: Int) = IntcodeComputer(program).diagnostic(input.toLong())

    fun part2(input: Int) = part1(input)

    private class IntcodeComputer(val rom: List<Long>) {
        ...
        fun diagnostic(input: Long): MutableList<Long> {
